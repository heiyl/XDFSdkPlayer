...
//		String defJoinPwd = "333333";
		...
		String defDomain = "xdfjt.gensee.com";
		String defNumber = "99310246";
		String defNickName = "fastsdk_test_android";
		String defJoinPwd = "372601";
...
//				: HANDlER.CACHING_END);
	...
	public void onClick(View v) {
		if (v.getId() == R.id.gs_bnt_room_join) {
			if (!bJoinSuccess) {
