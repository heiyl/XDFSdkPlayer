...
public class CustomGSImplChatView extends CustomGSChatView {

	public CustomGSImplChatView(Context context) {
		super(context);
	}

	public CustomGSImplChatView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public CustomGSImplChatView(Context context, AttributeSet attrs, int defStyle) {
	...
	protected View getView(Context context) {
		...
		return inflater.inflate(R.layout.xdf_player_chat_view_layout, null);
	}
	...
	@Override
	protected CustomAbsChatAdapter getChatAdapter(Context context) {
		return new CustomChatImplAdapter(context);
	}
